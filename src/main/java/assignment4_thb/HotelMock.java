...
public class HotelMock {
    ...
    /*public static List<Booking> createBookings(List<Hotel> hotels) {
        ...
        bookings.add(new Booking("Sunna", hotels.get(0), "03-04-25", "13-04-25"));
        bookings.add(new Booking("Silja", hotels.get(1), "05-12-25", "11-12-25"));
        bookings.add(new Booking("Katrín", hotels.get(2), "06-01-25", "22-01-25"));
        bookings.add(new Booking("Jónas", hotels.get(3), "07-04-25", "10-04-25"));
        return bookings;
    }*/
}
